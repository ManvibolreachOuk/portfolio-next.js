...
const About = () => {
    return (
        <div className='w-full md:h-screen p-2 flex items-center py-16 bg-white'>
            <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
                <div className='col-span-2'>
                    ...
                    <Link href='https://drive.google.com/file/d/10DJGfcvwWAlYFk52tYkdUjGLnZ_de5_3/view'>
                        <p className='bg-gradient-to-r from-cyan-500 text-white px-4 py-2 rounded-md w-40 hover:scale-105'>Resume</p>
                    </Link>
                    <p className= 'py-4 text-grey-600 underline cursor-pointer'>Check out some of my projects.</p>
                </div>
